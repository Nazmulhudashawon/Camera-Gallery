    ...
    return (
        ...
        <AppBar sx={{color:"white" }} position="static">
          <Toolbar style={{backgroundColor:"white",color:"black"}}>
            ...
            >
             CAMERA <span style={{color:"tomato",fontWeight:'700'}}>GALLERY</span>
            </Typography>
            <Search>
              <SearchIconWrapper>
                <SearchIcon />
            ...
            <Button sx={{color:'black'}} variant="text">My Order</Button>
            <Button sx={{color:'black'}} variant="text">Photograpy Tips</Button>
